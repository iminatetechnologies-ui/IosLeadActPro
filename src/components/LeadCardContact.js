      ...
      <Pressable
        ...
        <View style={styles.topRightRow}>
          <View style={styles.leadTypeBox}>
            <Text style={styles.statusText1}>⭐ {leadtype}</Text>
          </View>
          <View style={styles.statusBox}>
            <Text style={styles.statusText2}>
              {substatus_name || status_name}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.textContainer}>
          ...
          <Text style={styles.row}>
            ...
            <Text style={styles.value}>{created_date}</Text>
          </Text>
        </View>
        ...
        <View style={styles.iconContainer}>
          <TouchableOpacity
            ...
            // onPress={handleCallPress} // ✅ yaha direct function use kiya
...
const styles = StyleSheet.create({
  card: {
    ...
    shadowColor: '#000',
    shadowOffset: {width: 0, height: rh(1.5)}, // shadow नीचे की ओर
    shadowOpacity: 0.2,
    shadowRadius: rw(2),
    elevation: 4, // Android के लिए
    position: 'relative',
  },
